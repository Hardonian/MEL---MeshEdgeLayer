...
func New(cfg config.Config, debug bool) (*App, error) {
	...
	app.Web.SetIncidentMoatExtensions(app.PatchIncidentWorkflow, app.RecordRecommendationOutcome, app.IncidentReplayView, app.BuildEscalationBundle, app.PatchIncidentDecisionPackAdjudication)
