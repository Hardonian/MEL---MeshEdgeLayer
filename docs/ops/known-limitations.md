...
- MEL does not prove serial hardware endurance, broker scalability, cloud monitoring, or OTA readiness from repo-local tests alone; those require deployment-specific verification outside this repository.
